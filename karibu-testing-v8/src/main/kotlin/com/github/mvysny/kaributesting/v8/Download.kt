 ...
 * more details.
 */
public fun Link._download(): ByteArray {
    checkEditableByUser()
    return download()
}
 ...
 * are rejected with [AssertionError].
 */
public fun Link.download(): ByteArray {
 ...
 * are rejected with [AssertionError].
 */
public fun Resource.download(): ByteArray = when (this) {
 ...
 */
public fun ThemeResource.download(): ByteArray {
 ...
 */
public fun ConnectorResource.download(): ByteArray = stream.stream.use { it.readBytes() }
