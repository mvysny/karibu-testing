...
/**
 * A mocking service that performs the following important tasks:
...
internal fun VaadinService.setAtmosphereAvailable(available: Boolean) {
    val fAvailable: Field = VaadinService::class.java.getDeclaredField("atmosphereAvailable")
    fAvailable.isAccessible = true
    fAvailable.set(this, available)
}
