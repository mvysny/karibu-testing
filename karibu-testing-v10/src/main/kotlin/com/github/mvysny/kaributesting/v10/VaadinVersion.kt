...
public object VaadinMeta {
     ...
     */
    public val flowVersion: SemanticVersion by lazy(LazyThreadSafetyMode.PUBLICATION) {
        SemanticVersion(
     ...
     */
    public val fullVersion: SemanticVersion by lazy(LazyThreadSafetyMode.PUBLICATION) {
